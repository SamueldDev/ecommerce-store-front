...
// const dummyCart = [
//   { id: 1, name: "Linen Shirt", price: 49.99, quantity: 2 },
//   { id: 2, name: "Leather Tote", price: 89.99, quantity: 1 },
// ];
...
//     e.preventDefault();
//     console.log("Order submitted", billing);
...
//       const orderDetails = {
//         name: billing.name,
//         orderNumber: Math.floor(Math.random() * 100000), // Generating a random order number
//         items: dummyCart,
//         estimatedDelivery: "2025-05-10", // Just a static date for now
//       };
    
//       // Navigate to order confirmation page with order details
//       console.log("Navigating to confirmation", orderDetails);
